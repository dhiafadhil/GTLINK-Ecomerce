                            ...
                            <form id="update" action="../../model/user/approval_confirm.php" method="POST">
                                ...
                                <div class="row form-group p-l-20">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="username" readonly class="form-control"
                                ...
                                <div class="row form-group p-l-20">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="lokasi" class="form-control" value="<?php echo $lokasi;?>" readonly>
                                    </div>
                                </div>
                                <?php if(isset($top_user)){ ?>
                                <div class="row form-group p-l-20">
                                    <div class="col col-md-3">
                                        <label for="text-input" class=" form-control-label">Top User</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="username" class="form-control" value="<?php echo $top_user;?>" readonly>
                                    </div>
                                </div>
                                <?php } ?>
                                <div class="row form-group p-l-20">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="level" class="form-control" value="<?php echo $level;?>" readonly>
                                    </div>
                                </div>
                                <div class="row form-group p-l-20">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea type="textarea" id="text-areainput" name="status" rows="1" class="form-control" readonly><?php if ($status == 0)
                                                {
                                                echo "Un Publish";
                                                }
                                                else {
